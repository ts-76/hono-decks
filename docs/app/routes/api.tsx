...
export default createRoute((c) => {
  ...
  return c.render(
    <DocsLayout activePath="/api" title={title} description={description} sections={sectionsByLocale[locale]} locale={locale}>
      <aside class="version-note"><strong>hono-decks 0.2.1</strong><span>{isJa ? "アプリが直接選ぶ主要APIを、package.jsonのexportsと実装に基づいて説明します。" : "This page explains the primary APIs applications choose directly, based on package exports and source."}</span></aside>
      <section id="start">
