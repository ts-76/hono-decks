...
const runtimeDefinitions: ApiDefinition[] = [
  ...
  { id: "define-decks-config", symbol: "defineDecksConfig", entry: "@hono/decks", signature: "defineDecksConfig(config: DecksConfig): DecksConfig", description: { ja: "app-owned configuration の型を保ったまま定義します。", en: "Defines app-owned configuration while preserving its types." }, guide: "/docs/getting-started", source: "server/define-decks.ts" },
  { id: "merge-router-options", symbol: "mergeDecksRouterOptions", entry: "@hono/decks", signature: "mergeDecksRouterOptions(base, overrides): DecksRouterOptions", description: { ja: "base と application/request overrides を nested option ごとに合成します。", en: "Merges base and application/request overrides across nested options." }, guide: "/docs/routing", source: "server/define-decks.ts" },
];
