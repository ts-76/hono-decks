...
export default createRoute((c) => {
  ...
  return c.render(
    <DocsLayout activePath="/api" title={title} description={description} sections={sectionsByLocale[locale]} locale={locale}>
      <aside class="version-note"><strong>hono-decks 0.3.0</strong><span>{isJa ? "package.jsonのexportsと実装に基づき、アプリから直接使う主なAPIを掲載しています。" : "This page explains the primary APIs applications choose directly, based on package exports and source."}</span></aside>
      <section id="start">
