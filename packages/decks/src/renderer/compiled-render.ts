...
@media screen{body[data-hono-decks-print-preview]{min-height:100vh;overflow:auto;background:#e5e7eb;color:#000;--hono-decks-print-gap:6mm;--hono-decks-print-slot-height:80mm;--hono-decks-print-scale:.28}
